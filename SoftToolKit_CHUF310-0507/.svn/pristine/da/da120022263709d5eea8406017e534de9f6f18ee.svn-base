#pragma once
#include "Config.h"
class CConfig570 : public CConfig
{
public:
	CConfig570( unsigned short type );
	virtual ~CConfig570();
...
public:
	//config
	unsigned short ic_2_sensor_map[MAX_RX_NUM_570 + MAX_TX_NUM_570];
	unsigned short sensor_2_ic_map[MAX_RX_NUM_570 + MAX_TX_NUM_570];
