#pragma once
#include "Config.h"
class CConfig5562 : public CConfig
{
public:
	CConfig5562( unsigned short type );
	virtual ~CConfig5562();
...
// 	unsigned short os_base[MAX_SCAP_ROW][MAX_SCAP_COL];
	...
	unsigned int  tick_96m_standard;
	unsigned int  tick_96m_standardNo2;
	unsigned int  tick_96m_standardNo3;
	unsigned int  tick_96m_standardNo4;
	unsigned int  tick_96m_standardNo5;
	unsigned short trim_96m_min;
	unsigned short trim_96m_max;
	unsigned short offset_96m;
...
// 	/*unsigned*/ short base_max[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	//signed short vt_min;
	signed short vt_max;
	unsigned short vt_on[1][MAX_MCAP_ROW];
	unsigned short vt_off[1][MAX_MCAP_ROW];
	unsigned short vt_diff_max[1][MAX_MCAP_ROW];

	//noise test
	unsigned char noise_selected;
	signed short noise_frame;

	short noise_mcap_base[MAX_MCAP_ROW][MAX_MCAP_COL];
	short noise_scap_base[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	unsigned char uniformity_invalid_node[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	unsigned char  tmp_invalid_node[MAX_MCAP_ROW][MAX_MCAP_COL]; 

	//unsigned char base_save_data;
	//unsigned char base_simplifyA_algorithm;

	unsigned short tmp_1_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_2_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_3_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_4_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_5_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_6_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_7_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short tmp_8_mcapdata[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	unsigned short fsd_fast[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short fsd_slow[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short fsd_diff_max[MAX_MCAP_ROW][MAX_MCAP_COL];

	unsigned char fsd_fast_mcap_test;
	unsigned short fsd_fast_mcap_limit;

	unsigned short fsd_fast_min[MAX_MCAP_ROW][MAX_MCAP_COL];
	unsigned short fsd_fast_max[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	//float fator_HL[MAX_MCAP_ROW][MAX_MCAP_COL];
	/**************************************************************/
};