...
{
    public class BasicSetMode5562 : TestItemSetMode5562
    {
        public override void XMLDataToView()
        {
            ...
            if(null != osctrimItem)
            {
                ...
                osctrimItem.Trim96MStandard = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standard", 96000);
                osctrimItem.Trim96MStandardNo2 = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo2", 88000);
                osctrimItem.Trim96MStandardNo3 = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo3", 92000);
                osctrimItem.Trim96MStandardNo4 = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo4", 100000);
                osctrimItem.Trim96MStandardNo5 = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo5", 104000);
                osctrimItem.Trim96MMin = GetXmlAttrbuteValue(stNode, "osctrim_test", "trim_96m_min", 0x25);
                osctrimItem.Trim96MMax = GetXmlAttrbuteValue(stNode, "osctrim_test", "trim_96m_max", 0x1d4);
                osctrimItem.Offset96M = (uint)GetXmlAttrbuteValue(stNode, "osctrim_test", "offset_96m", 30);
...
//             }
        ...
        public override void ViewToXMLData()
        {
            ...
            if (null != osctrimItem)
            {
                ...
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standard", osctrimItem.Trim96MStandard);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo2", osctrimItem.Trim96MStandardNo2);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo3", osctrimItem.Trim96MStandardNo3);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo4", osctrimItem.Trim96MStandardNo4);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_96m_standardNo5", osctrimItem.Trim96MStandardNo5);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "trim_96m_min", osctrimItem.Trim96MMin);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "trim_96m_max", osctrimItem.Trim96MMax);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "offset_96m", osctrimItem.Offset96M > 500 ? 500 : osctrimItem.Offset96M);
