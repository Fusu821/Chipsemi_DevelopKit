...
{
    public class BasicSetMode5816 : TestItemSetMode5816
    {
...
//             }
            ...
            if(null != osctrimItem)
            {
                ...
                osctrimItem.Trim24MStandard = GetXmlAttrbuteValue(stNode, "osctrim_test", "tick_24m_standard", 24000);
                osctrimItem.Trim24MMin = GetXmlAttrbuteValue(stNode, "osctrim_test", "trim_24m_min", 0x50);
                osctrimItem.Trim24MMax = GetXmlAttrbuteValue(stNode, "osctrim_test", "trim_24m_max", 0xA0);
            }
...
//             }
            ...
            if (null != ioVolItem)
            {
                ...
                ioVolItem.LowLevelVddMin = GetXmlAttrbuteValue(stNode, "iovol_test", "vdd_low_min", 2700);
                ioVolItem.LowLevelVddMax = GetXmlAttrbuteValue(stNode, "iovol_test", "vdd_low_max", 2900);
                ioVolItem.HighLevelVddMin = GetXmlAttrbuteValue(stNode, "iovol_test", "vdd_high_min", 2700);
                ioVolItem.HighLevelVddMax = GetXmlAttrbuteValue(stNode, "iovol_test", "vdd_high_max", 2900);
            }
            ...
            if (null != currentItem)
            {
                ...
                currentItem.IdleCurrentMin = GetXmlAttrbuteValue(stNode, "current_test", "idle_current_min", 500);
                currentItem.IdleCurrentMax = GetXmlAttrbuteValue(stNode, "current_test", "idle_current_max", 3000);
                ...
                currentItem.PowerSupply = (ushort)GetXmlAttrbuteValue(stNode,    "current_test", "power_supply", 0);
        ...
        public override void ViewToXMLData()
        {
            ...
            if (null != currentItem)
            {
                ...
                SaveXmlAttrbuteValue(stNode, "current_test", "power_supply", currentItem.PowerSupply);
            }
...
//             }
            ...
            if (null != osctrimItem)
            {
                ...
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "tick_24m_standard", osctrimItem.Trim24MStandard);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "trim_24m_min", osctrimItem.Trim24MMin);
                SaveXmlAttrbuteValue(stNode, "osctrim_test", "trim_24m_max", osctrimItem.Trim24MMax);
            }
...
//             }
            ...
            if (null != ioVolItem)
            {
                ...
                SaveXmlAttrbuteValue(stNode, "iovol_test", "vdd_low_min", ioVolItem.LowLevelVddMin);
                SaveXmlAttrbuteValue(stNode, "iovol_test", "vdd_low_max", ioVolItem.LowLevelVddMax);
                SaveXmlAttrbuteValue(stNode, "iovol_test", "vdd_high_min", ioVolItem.HighLevelVddMin);
                SaveXmlAttrbuteValue(stNode, "iovol_test", "vdd_high_max", ioVolItem.HighLevelVddMax);
            }
