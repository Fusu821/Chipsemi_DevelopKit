...
REGIST_RUNTIME_CLASS( CHIP_TYPE, (CHIP_TYPE)SEMI_IC_7126, CChip7126 )

	typedef CChip7126 CChip5460S;
REGIST_RUNTIME_CLASS(CHIP_TYPE, (CHIP_TYPE)SEMI_IC_5460S, CChip5460S)

	typedef CChip7126 CChip5560;
REGIST_RUNTIME_CLASS(CHIP_TYPE, (CHIP_TYPE)SEMI_IC_5560, CChip5560)
	typedef CChip7126 CChip7562;
...
unsigned int CChip7126Imp::SetCommContext( const CtpHalCfg& halCfg )
{
...
unsigned int CChip7126Imp::GetOSCTrim( unsigned char* trim32k, unsigned char* trim96m, unsigned char* trim250m, unsigned char trim_mode, unsigned int osStd32k, unsigned int osStd96m, unsigned int osStd250m )
{
	unsigned int iReCode = ERROR_CODE_OK;
...
unsigned int  CChip7126Imp:: GetOSCTrimN( unsigned char* trim32k, unsigned char* trim96m, unsigned char* trim250m, unsigned char trim_mode, unsigned int osStd32k, unsigned int osStd96m, unsigned int osStd250m,unsigned int osStd96mNo2,unsigned int osStd96mNo3,unsigned int osStd96mNo4,unsigned int osStd96mNo5 )
{
	unsigned int iReCode = ERROR_CODE_OK;
	unsigned int *ptrim32k = (unsigned int *)trim32k;
	unsigned int *ptrim96m = (unsigned int *)trim96m;
...
unsigned int CChip7126Imp::GetShortData( unsigned short* sData, unsigned short len )
{
	unsigned int iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetBootVersion( unsigned short* bootVer )
{
...
unsigned int CChip7126Imp::GetBootCheckSum( unsigned int* checkSum, unsigned int* omTime )
{
	unsigned char iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetFirmWareConfig( unsigned char* configBuffer, unsigned short len )
{
	unsigned char iReCode = ERROR_CODE_OK;
...
unsigned int CChip7126Imp::BurnBootBin( unsigned int bootLen, unsigned int bootSVN/* = 0*/, unsigned short oscTrim /*= 0*/ )
{
	unsigned char iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::BurnConfigBin( const unsigned char* config, unsigned short len )
{
	unsigned int iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::EraseBurnSpace( unsigned int addr, unsigned int len )
{
	unsigned int iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
// unsigned int CChip7126Imp::GetIoVoltage( unsigned int (&voltage)[2][8] )
// {
// 	unsigned char iReCode = ERROR_CODE_OK;
// 
// 	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
...
// 	return iReCode;
// }
// unsigned int CChip7126Imp::GetCurrent( unsigned short* activeCurrrent, unsigned short* sleepCurrent, unsigned short* deepCurrent )
// {
// 	unsigned int iReCode = ERROR_CODE_OK;
// 	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
// 	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
// 	return iReCode;
// }
unsigned int CChip7126Imp::SetClkInFctMode( unsigned short clk, unsigned char filterOff )
{
...
unsigned int CChip7126Imp::GetDifferMax(unsigned short frames, short* sData, unsigned short len )
{
	unsigned int iReCode = ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetCurrent55xx( short (&level)[2][3], unsigned short* activeCurrrent, unsigned short* sleepCurrent, unsigned short* deepCurrent, unsigned short* vbactiveCurrrent, unsigned short* vbsleepCurrent, unsigned short* vbdeepCurrent )
{
	unsigned int iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetNewBootCheckSum(unsigned int* checkSum, unsigned int* omTime, unsigned int* bootloadercheckSum)
{
	unsigned char iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::CheckCatchBootToMtk(unsigned int addr, unsigned char* bootBuffer, unsigned int bootLen, LPCheckCatchBootCallBack onBootCallBack/* = NULL */)
{
...
unsigned int CChip7126Imp::GetTrimeDosc(fct_osc_trim& fo_trim)
{
	unsigned char iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetVtData(unsigned short* sData, unsigned short len)
{
	unsigned int iReCode = ERROR_CODE_OK;
	ICommBase* pComBase = GetWrapperAddr()->GetCommBaseInterface();
	if( !pComBase )  return ERROR_CODE_COMM_ERROR;
...
unsigned int CChip7126Imp::GetFwData(short* sData, unsigned short len)
{
	unsigned int iReCode = ERROR_CODE_COMM_ERROR;
