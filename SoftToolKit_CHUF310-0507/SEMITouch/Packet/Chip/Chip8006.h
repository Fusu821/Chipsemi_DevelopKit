...
class CChip8006Imp : public CChipMcapImp, public ISMChip8006Part
{
public:
	CChip8006Imp();
	virtual ~CChip8006Imp();
...
public:
	...
	unsigned int GetOSCTrim( unsigned char* trim32k, unsigned char* trim64m,unsigned int osStd32k, unsigned int osStd64m ) override;
	...
	unsigned int GetCurrent8006( short (&level)[2][3], unsigned short* activeCurrrent, unsigned short* sleepCurrent, unsigned short* deepCurrent, unsigned short* vbactiveCurrrent, unsigned short* vbsleepCurrent, unsigned short* vbdeepCurrent ) override;
	...
	unsigned int WriteBurnSpace( unsigned int addr, const unsigned char* buffer, unsigned int len, unsigned char type ) override;
	unsigned int ReadBurnSpace( unsigned int addr, unsigned char* buffer, unsigned int len )override;
};



class CChip8006 : public ISMChip8006
{
public:
	CChip8006(){}
	virtual ~CChip8006(){}
public:
	...
	inline unsigned int GetOSCTrim( unsigned char* trim32k, unsigned char* trim64m,unsigned int osStd32k, unsigned int osStd64m ){
		return m_Impl.GetOSCTrim( trim32k, trim64m, osStd32k, osStd64m);
	}
	...
	inline unsigned int GetCurrent8006( short (&level)[2][3], unsigned short* activeCurrrent, unsigned short* sleepCurrent, unsigned short* deepCurrent, unsigned short* vbactiveCurrrent, unsigned short* vbsleepCurrent, unsigned short* vbdeepCurrent ){
		return m_Impl.GetCurrent8006( level, activeCurrrent, sleepCurrent, deepCurrent,vbactiveCurrrent,vbsleepCurrent ,vbdeepCurrent );
	}
