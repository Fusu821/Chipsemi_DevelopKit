...
class CChip7449Imp : public CChipMcapImp, public ISMChip7449Part
{
public:
	CChip7449Imp();
	virtual ~CChip7449Imp();
...
public:
	...
	unsigned int GetNewBootVersion( unsigned short* bootVer,unsigned int addr ) override;
};
class CChip7449 : public ISMChip7449
{
public:
	CChip7449(){}
	virtual ~CChip7449(){}
...
// 	}
	...
	inline unsigned GetNewBootVersion( unsigned short* bootVer,unsigned int addr ){
		return m_Impl.GetNewBootVersion( bootVer,addr );
	}
private:
	CChip7449Imp m_Impl;
};