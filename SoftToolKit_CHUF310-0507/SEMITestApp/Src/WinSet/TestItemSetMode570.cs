...
namespace SEMITestApp.Src.WinSet
{
    ...
    {
        public void RegistReflex570TestItemSetMode()
        {
            RegistByTypeAndId(SMInvokeBridge.eChipTypeList.SM_IC_570, "SEMITestApp.Src.WinSet.TestItemSetMode570", SEMI.Util.ChipReflex.SEMI_TEST_ITEM_SET_MODE);
        }
    }
    public class TestItemSetMode570 : SettingMode
    {
