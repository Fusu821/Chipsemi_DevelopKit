...
{
    public class BasicSetMode5472 : TestItemSetMode5472
    {
        public override void XMLDataToView()
        {
            ...
            var frtItem = TestItemList.FirstOrDefault((t) => { return t.Name == "frt_test" ? true : false; }) as FRTTestItem;
            if (null != frtItem)
            {
                frtItem.CheckZbit = GetXmlAttrbuteValue(stNode, "frt_test", "check_zbit", 0) > 0 ? true : false;
            }
...
//             }
            ...
            if (null != vtItem)
            {
                vtItem.VTTestTxMin = (short)GetXmlAttrbuteValue(stNode, "vt_test", "vt_tx_min", 100);
                vtItem.VTTestTxMax = (short)GetXmlAttrbuteValue(stNode, "vt_test", "vt_tx_max", 1000);
                vtItem.VTTestRxMin = (short)GetXmlAttrbuteValue(stNode, "vt_test", "vt_rx_min", 100);
                vtItem.VTTestRxMax = (short)GetXmlAttrbuteValue(stNode, "vt_test", "vt_rx_max", 1000);
            }
            ...
            if (null != noiseItem)
            {
                ...
                noiseItem.NoiseTestMaxBase = (short)GetXmlAttrbuteValue(stNode, "noise_test", "noise_max_base", 100);
                noiseItem.NoiseTestMaxBaseScap = (short)GetXmlAttrbuteValue(stNode, "noise_test", "noise_max_base_scap", 100);

                noiseItem.CheckHardwareNoise = 1 == GetXmlAttrbuteValue(stNode, "noise_test", "check_hardware_noise", 1);
                noiseItem.H_F_NoiseMax = (ushort)GetXmlAttrbuteValue(stNode, "noise_test", "h_f_noise_max", 80);
                noiseItem.H_AF_NoiseMax = (ushort)GetXmlAttrbuteValue(stNode, "noise_test", "h_af_noise_max", 80);
            }
        ...
        public override void ViewToXMLData()
        {
            ...
            if (null != frtItem)
            {
                SaveXmlAttrbuteValue(stNode, "frt_test", "check_zbit", frtItem.CheckZbit ? 1 : 0);
            }
...
//             }
            ...
            if (null != vtItem)
            {
                SaveXmlAttrbuteValue(stNode, "vt_test", "vt_tx_min", vtItem.VTTestTxMin);
                SaveXmlAttrbuteValue(stNode, "vt_test", "vt_tx_max", vtItem.VTTestTxMax);
                SaveXmlAttrbuteValue(stNode, "vt_test", "vt_rx_min", vtItem.VTTestRxMin);
                SaveXmlAttrbuteValue(stNode, "vt_test", "vt_rx_max", vtItem.VTTestRxMax);
            }
            ...
            if (null != noiseItem)
            {
                ...
                SaveXmlAttrbuteValue(stNode, "noise_test", "noise_max_base", noiseItem.NoiseTestMaxBase);
                SaveXmlAttrbuteValue(stNode, "noise_test", "noise_max_base_scap", noiseItem.NoiseTestMaxBaseScap);

                SaveXmlAttrbuteValue(stNode, "noise_test", "check_hardware_noise", noiseItem.CheckHardwareNoise ? 1 : 0);
                SaveXmlAttrbuteValue(stNode, "noise_test", "h_f_noise_max", noiseItem.H_F_NoiseMax);
                SaveXmlAttrbuteValue(stNode, "noise_test", "h_af_noise_max", noiseItem.H_AF_NoiseMax);
            }
