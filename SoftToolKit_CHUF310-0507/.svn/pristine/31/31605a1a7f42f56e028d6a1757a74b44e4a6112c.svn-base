#ifndef __HAL_TCPCLIENT_SRV_PROXY__
#define __HAL_TCPCLIENT_SRV_PROXY__
/**************************************************************************************/
#include "HalServiceInterface.h"
#include "HalTcpClientService.h"
class CHalTcpClientServiceProxy : public IHalServiceInterface
{
public:
	CHalTcpClientServiceProxy();
	virtual ~CHalTcpClientServiceProxy();
...
private:
	CHalTcpClientLayerService m_HalSrvAddr;
};
/**************************************************************************************/
#endif