#ifndef __HAL_HID_IIC_LAYER_SERVICE__
#define __HAL_HID_IIC_LAYER_SERVICE__
/**************************************************************************************/
#include "Wait.h"
#include "RefBase.h"
...
class CHalHIDIICLayerService : public CBSPRService
{
private:
	CHalHIDIICLayerService( const CHalHIDIICLayerService& );
public:
	CHalHIDIICLayerService(  );
	virtual ~CHalHIDIICLayerService();
	...
	***************************************************************************************/
	BOOL HasReceiveDataInQueue( UINT32 queryTimeout );
 	...
 	DECLEAR_SERVICE( CHalHIDIICLayerService )
