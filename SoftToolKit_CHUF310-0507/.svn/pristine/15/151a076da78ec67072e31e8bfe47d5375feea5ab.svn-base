...
namespace SEMIDevelopKit.Src.Util
{
    ...
    {
        public static string password = "idc_studio";
    ...
    public class UnZipClass
    {
        ...
        public static bool UnZip(string fileToUnZip, string zipedFolder, string password)
        {
            ...
            try
            {
                ...
                while ((ent = zipStream.GetNextEntry()) != null)
                {
                    if (!string.IsNullOrEmpty(ent.Name))
                    {
                        ...
                        fs = new System.IO.FileStream(fileName, System.IO.FileMode.CreateNew);/*File.Create(fileName);*/
                        int size = 2048;
            ...
            {
                MessageBox.Show("UnZip Error, Path=" + fileName + "len=" + fileName.Length + "\r\n" + zipedFolder + "\r\n" +
                    e.ToString());
                result = false;
            }
            finally
