...
class CChip3536Imp : public CChipScapImp, public ISMChip3536Part
{
public:
	CChip3536Imp();
	virtual ~CChip3536Imp();
...
public:
	...
	unsigned int GetOSData( unsigned char integral, unsigned char scale_a, unsigned char scale_b, unsigned short osClk, unsigned short* osData, unsigned short len );
	...
	unsigned int GetVirtualTouchData( unsigned short xyClk, unsigned short scale, unsigned short integral, unsigned short* vtData1, unsigned short* vtData2, unsigned short len );
	unsigned int GetIoVoltage( unsigned int (&voltage)[2][8] );
	virtual unsigned int GetTrimeDosc(int& fo_trim) override;
	
};
class CChip3536 : public ISMChip3536
{
public:
	CChip3536(){}
	virtual ~CChip3536(){}
...
// 	}
	...
	//////////////////////////////////////////////////////////////////////////
	inline unsigned int GetOSData( unsigned char integral, unsigned char scale_a, unsigned char scale_b, unsigned short osClk, unsigned short* osData, unsigned short len ){
		return m_Impl.GetOSData( integral, scale_a, scale_b, osClk, osData, len );
	}
	...
	inline unsigned int GetVirtualTouchData( unsigned short xyClk, unsigned short scale, unsigned short integral, unsigned short* vtData1, unsigned short* vtData2, unsigned short len ){
		return m_Impl.GetVirtualTouchData( xyClk, scale, integral, vtData1, vtData2, len );
	}
	inline unsigned int GetIoVoltage( unsigned int (&voltage)[2][8] ){
		return m_Impl.GetIoVoltage( voltage );
	}

	inline unsigned int GetTrimeDosc(int& fo_trim){
