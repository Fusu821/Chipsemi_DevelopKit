...
class CChip5472Imp : public CChipMcapImp, public ISMChip5472Part
{
public:
	CChip5472Imp();
	virtual ~CChip5472Imp();
...
public:
	...
	unsigned int GetOSCTrim( unsigned char* trim32k, unsigned char* trim48m, unsigned char* trim150m, unsigned char trim_mode, unsigned int osStd32k, unsigned int osStd48m, unsigned int osStd150m );
	...
	unsigned int GetDifferMaxNew(unsigned short frames, unsigned short tag, short* sData, unsigned short len );
};
class CChip5472 : public ISMChip5472
{
public:
	CChip5472(){}
	virtual ~CChip5472(){}
...
public:
	...
	inline unsigned int GetOSCTrim( unsigned char* trim32k, unsigned char* trim48m, unsigned char* trim150m, unsigned char trim_mode, unsigned int osStd32k, unsigned int osStd48m, unsigned int osStd150m ){
		return m_Impl.GetOSCTrim( trim32k, trim48m, trim150m, trim_mode, osStd32k, osStd48m, osStd150m );
	}
...
// 	}
	...
	inline unsigned int GetDifferMaxNew(unsigned short frames, unsigned short tag, short* sData, unsigned short len ){
		return m_Impl.GetDifferMaxNew(frames, tag, sData, len);
	}
private:
	CChip5472Imp m_Impl;
};