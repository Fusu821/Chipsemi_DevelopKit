...
namespace SEMITestApp.Src.WinSet
{
    ...
    {
        public void RegistReflex7126TestItemSetMode()
        {
            RegistByTypeAndId(SMInvokeBridge.eChipTypeList.SM_IC_7126, "SEMITestApp.Src.WinSet.TestItemSetMode7126", SEMI.Util.ChipReflex.SEMI_TEST_ITEM_SET_MODE);
        }
    }
    public class TestItemSetMode7126 : SettingMode
    {
        ...
        public class OSCTrimTestItem : TestItem
        {
            ...
            private int trim144MStandard = 144000;
            public int Trim144MStandard
            {
                get { return trim144MStandard; }
                set { if (value != trim144MStandard) { trim144MStandard = value; OnPropertyChanged("Trim144MStandard"); } }
            }
            private int trim144MStandardNo2 = 136000;
            public int Trim144MStandardNo2
            {
                get { return trim144MStandardNo2; }
                set { if (value != trim144MStandardNo2) { trim144MStandardNo2 = value; OnPropertyChanged("Trim144MStandardNo2"); } }
            }

            private int trim144MStandardNo3 = 140000;
            public int Trim144MStandardNo3
            {
                get { return trim144MStandardNo3; }
                set { if (value != trim144MStandardNo3) { trim144MStandardNo3 = value; OnPropertyChanged("Trim144MStandardNo3"); } }
            }

            private int trim144MStandardNo4 = 148000;
            public int Trim144MStandardNo4
            {
                get { return trim144MStandardNo4; }
                set { if (value != trim144MStandardNo4) { trim144MStandardNo4 = value; OnPropertyChanged("Trim144MStandardNo4"); } }
            }

            private int trim144MStandardNo5 = 152000;
            public int Trim144MStandardNo5
            {
                get { return trim144MStandardNo5; }
                set { if (value != trim144MStandardNo5) { trim144MStandardNo5 = value; OnPropertyChanged("Trim144MStandardNo5"); } }
            }

            private int trim144MMin = 0x25;
            public int Trim144MMin
            {
                get { return trim144MMin; }
                set { if (value != trim144MMin) { trim144MMin = value; OnPropertyChanged("Trim144MMin"); } }
            }

            private int trim144MMax = 0x1d4;
            public int Trim144MMax
            {
                get { return trim144MMax; }
                set { if (value != trim144MMax) { trim144MMax = value; OnPropertyChanged("Trim144MMax"); } }
            }

            private uint offset144M = 30;
            public uint Offset144M
            {
                get { return offset144M; }
                set { if (value != offset144M) { offset144M = value; OnPropertyChanged("Offset144M"); } }
            }
        ...
        public class WDogTestItem : TestItem
        {
        ...
        protected static IList<TestItem> testItems = new List<TestItem>()
        {
            ...
            new WDogTestItem(){ID = 21, Name="wdogt_test", ItemText="WDT", MustRequied=false},
        };
