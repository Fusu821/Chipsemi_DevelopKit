...
{
    public class Model5472 : ModelBase
    {
        ...
        public Model5472()
        {
            ModeCatch.Register(SMDevelopChipReflex.SEMI_DEVLOP_RAWDATA, eChipTypeList.SM_IC_5472, this);
        }
...
//             baseAddr = 0x20000000 + ((uint)(header[0x25] << 16) + header[0x24]);
        ...
        {
            return SMChip5472.BurnConfigBin(buffer, (ushort)len);
        ...
        {
            return SMChip5472.GetFirmWareConfig(buffer, (ushort)len);
        }
        public override uint WritePram(byte[] buffer, uint len)
        {
            Mcap5472.TPWritePramAction item = new Mcap5472.TPWritePramAction(0, "Write Pram", 0x20000000, 0);
