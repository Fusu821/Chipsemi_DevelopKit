#ifndef __HAL_HID_LAYER_PROXY__
#define __HAL_HID_LAYER_PROXY__
/**************************************************************************************/
#include "HalServiceInterface.h"
#include "HalHIDLayerService.h"
class CHalHIDServiceProxy : public IHalServiceInterface
{
public:
	CHalHIDServiceProxy();
	virtual ~CHalHIDServiceProxy();
...
private:
	CHalHIDLayerService m_HalSrvAddr;
