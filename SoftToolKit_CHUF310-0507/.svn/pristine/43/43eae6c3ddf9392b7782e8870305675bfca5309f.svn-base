...
namespace SEMITestApp.Src.WinSet
{
    ...
    {
        public void RegistReflex810TestItemSetMode()
        {
            RegistByTypeAndId(SMInvokeBridge.eChipTypeList.SM_IC_810, "SEMITestApp.Src.WinSet.TestItemSetMode810", SEMI.Util.ChipReflex.SEMI_TEST_ITEM_SET_MODE);
        }
    }
    public class TestItemSetMode810 : SettingMode
    {
        public class CurrentTestItem : TestItem
        {
            ...
            private int suspend0CurrentMin = 0;
            public int Suspend0CurrentMin
            {
                get { return suspend0CurrentMin; }
                set { if (value != suspend0CurrentMin) { suspend0CurrentMin = value; OnPropertyChanged("Suspend0CurrentMin"); } }
            }

            private int suspend0CurrentMax = 100;
            public int Suspend0CurrentMax
            {
                get { return suspend0CurrentMax; }
                set { if (value != suspend0CurrentMax) { suspend0CurrentMax = value; OnPropertyChanged("Suspend0CurrentMax"); } }
            }

            private int suspend1CurrentMin = 0;
            public int Suspend1CurrentMin
            {
                get { return suspend1CurrentMin; }
                set { if (value != suspend1CurrentMin) { suspend1CurrentMin = value; OnPropertyChanged("Suspend1CurrentMin"); } }
            }

            private int suspend1CurrentMax = 100;
            public int Suspend1CurrentMax
            {
                get { return suspend1CurrentMax; }
                set { if (value != suspend1CurrentMax) { suspend1CurrentMax = value; OnPropertyChanged("Suspend1CurrentMax"); } }
            }
        }
        ...
        public class BaseTestItem : TestItem
        {
            ...
            private ushort exitSize = 3500;
            public ushort ExitSize
            {
                get { return exitSize; }
                set { if (value != exitSize) { exitSize = value; OnPropertyChanged("ExitSize"); } }
            }
        }
        ...
        protected static IList<TestItem> testItems = new List<TestItem>()
        {
            ...
            new BaseTestItem(){ID = 17, Name="base_test", ItemText="RockerCalib", MustRequied=true},
