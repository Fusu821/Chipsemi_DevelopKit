#pragma once
#include "Config.h"
class CConfig5472 : public CConfig
{
public:
	CConfig5472( unsigned short type );
	virtual ~CConfig5472();
...
public:
	//config
	unsigned short ic_2_sensor_map[MAX_RX_NUM_5472 + MAX_TX_NUM_5472];
...
// 	/*unsigned*/ short base_max[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	signed short vt_tx_min;
	signed short vt_tx_max;
    signed short vt_rx_min;
    signed short vt_rx_max;
	...
	signed short noise_max_base;
	signed short noise_max_base_scap;

	unsigned char noise_check_hardware_noise;
	unsigned short noise_h_f_noise_max;
	unsigned short noise_h_af_noise_max;
