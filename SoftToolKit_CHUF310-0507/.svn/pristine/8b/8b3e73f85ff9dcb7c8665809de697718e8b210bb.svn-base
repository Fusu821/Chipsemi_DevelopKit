...
#define AddrMakeTraceRecord  (208 + 4) * 1024
#define	AddrOSCTrim          (200 + 4) * 1024
#define	Addrbase             (204 + 4) * 1024

class CTest7449 : public CTestBase
{
//typedef TEST_ITEM_STATUS (CTest7449::*FunctionTest)( NativeTestItem& item );
public:
	CTest7449();
	virtual ~CTest7449();
...
private:
	...
	unsigned int EnPin_Test( NativeTestItem& itemQuote );
