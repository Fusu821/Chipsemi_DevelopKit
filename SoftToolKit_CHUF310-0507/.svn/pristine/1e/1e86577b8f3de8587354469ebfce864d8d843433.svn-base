...
{
    public class BasicSetMode8006 : TestItemSetMode8006
    {
...
//             }
            ...
            {
                SDRockerCalibItem.Y_Difference = (ushort)GetXmlAttrbuteValue(stNode, "sd_rocker_calib_test", "y_difference", 1000);
                SDRockerCalibItem.Y_Difference_neg = (ushort)GetXmlAttrbuteValue(stNode, "sd_rocker_calib_test", "y_difference_neg", 1000);
...
//             }
            ...
            if (null != SDRockerCalibItem)
            {
                SaveXmlAttrbuteValue(stNode, "sd_rocker_calib_test", "y_difference", SDRockerCalibItem.Y_Difference);
                SaveXmlAttrbuteValue(stNode, "sd_rocker_calib_test", "y_difference_neg", SDRockerCalibItem.Y_Difference_neg);
