...
void RefBase::incStrong(const void* id) const
{
	...
	const int32_t c = atomic_inc(&refs->mStrong);
...
void RefBase::decStrong(const void* id) const
{
	...
	const int32_t c = atomic_dec(&refs->mStrong);
	if (c == 1) {
...
void RefBase::weakref_type::incWeak(const void* id)
{
	...
	impl->addWeakRef(id);
	const int32_t c = atomic_inc(&impl->mWeak);
}
...
void RefBase::weakref_type::decWeak(const void* id)
{
	...
	const int32_t c = atomic_dec(&impl->mWeak);
	if (c != 1) return;
