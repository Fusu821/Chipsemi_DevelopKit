#include "framework.h"
#include "Config5562.h"
#include "checksum.h"
#include "../TestSrc/ToolKit.h"

#define MAX_BOT_BIN_SIZE_550 199*1024

REGIST_RUNTIME_CLASS_USHORT(CONFIG_TYPE, (CONFIG_TYPE)SEMI_IC_5562, CConfig5562)

typedef CConfig5562 CConfig5460S;
REGIST_RUNTIME_CLASS_USHORT(CONFIG_TYPE, (CONFIG_TYPE)SEMI_IC_5460S, CConfig5460S)

typedef CConfig5562 CConfig5560;
REGIST_RUNTIME_CLASS_USHORT(CONFIG_TYPE, (CONFIG_TYPE)SEMI_IC_5560, CConfig5560)

typedef CConfig5562 CConfig7562;
REGIST_RUNTIME_CLASS_USHORT(CONFIG_TYPE, (CONFIG_TYPE)SEMI_IC_7562, CConfig7562)

CConfig5562::CConfig5562( unsigned short type )
:CConfig(type)
{
	current_selected = 0;
	osctrim_selected = 0;
...
CConfig5562::~CConfig5562()
{

}
BOOL CConfig5562::Parse( const tinyxml2::XMLDocument& xmlDoc )
{
	...
	if( bRet )
	{
		...
		if( pOSCTrimConfig )
		{
			...
			tick_96m_standard = (unsigned int)pOSCTrimConfig->Int64Attribute("tick_96m_standard");
			tick_96m_standardNo2 = (unsigned int)pOSCTrimConfig->Int64Attribute("tick_96m_standardNo2");
			tick_96m_standardNo3 = (unsigned int)pOSCTrimConfig->Int64Attribute("tick_96m_standardNo3");
			tick_96m_standardNo4 = (unsigned int)pOSCTrimConfig->Int64Attribute("tick_96m_standardNo4");
			tick_96m_standardNo5 = (unsigned int)pOSCTrimConfig->Int64Attribute("tick_96m_standardNo5");
			trim_96m_min = (unsigned short)pOSCTrimConfig->Int64Attribute("trim_96m_min");
			trim_96m_max = (unsigned short)pOSCTrimConfig->Int64Attribute("trim_96m_max");
			offset_96m = (unsigned short)pOSCTrimConfig->Int64Attribute("offset_96m");
		...
		if( pWBaseConfig )
		{
			...
			if (1 == wbase_selected)
			{
				...
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_1_mcapdata,tmp_1_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_2_mcapdata", tmp_2_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_2_mcapdata,tmp_2_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_3_mcapdata", tmp_3_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_3_mcapdata,tmp_3_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_4_mcapdata", tmp_4_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_4_mcapdata,tmp_4_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_5_mcapdata", tmp_5_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_5_mcapdata,tmp_5_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_6_mcapdata", tmp_6_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_6_mcapdata,tmp_6_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_7_mcapdata", tmp_7_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_7_mcapdata,tmp_7_mcapdata,rowsCnt, colsCnt,1);

				ParseDetailData( pWBaseConfig, "tmp_8_mcapdata", tmp_8_mcapdata, rowsCnt, colsCnt, 1 );
				tmp_data_normalization<unsigned short, unsigned short, MAX_MCAP_ROW, MAX_MCAP_COL>(tmp_8_mcapdata,tmp_8_mcapdata,rowsCnt, colsCnt,1);

				//unsigned short (*tmp_base[8])[MAX_MCAP_COL] ={tmp_1_mcapdata,tmp_2_mcapdata,tmp_3_mcapdata,tmp_4_mcapdata,tmp_5_mcapdata,tmp_6_mcapdata,tmp_7_mcapdata,tmp_8_mcapdata};
		...
		if( pfsdConfig )
		{
			...
			{
				MatrixMultiplication<unsigned short,unsigned short,float,MAX_MCAP_ROW, MAX_MCAP_COL>(fsd_fast_min, fsd_fast,((float)(100 - fsd_fast_mcap_limit))/100, MAX_MCAP_ROW, MAX_MCAP_COL);

				MatrixMultiplication<unsigned short,unsigned short,float,MAX_MCAP_ROW, MAX_MCAP_COL>(fsd_fast_max, fsd_fast,((float)(100 + fsd_fast_mcap_limit))/100, MAX_MCAP_ROW, MAX_MCAP_COL);
			}
		}
	}	
	return bRet;
}
BOOL CConfig5562::CheckCfgBinFile( unsigned char* pCfg, unsigned int byteSize )
{
...
BOOL CConfig5562::SubParseFromConfig()
{
...
// 					vVersion = pV[0] >> 9;
					...
					/*Set_Key_Num = key_setting_num = cfgBinBuffer[0x52];//5562暂不支持按键
