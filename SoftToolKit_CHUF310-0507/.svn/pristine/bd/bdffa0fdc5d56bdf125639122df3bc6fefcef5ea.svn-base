#ifndef __HAL_USB_LAYER_PROXY__
#define __HAL_USB_LAYER_PROXY__
/**************************************************************************************/
#include "HalServiceInterface.h"
#include "HalUSBLayerService.h"
class CHalUSBServiceProxy : public IHalServiceInterface
{
public:
	CHalUSBServiceProxy();
	virtual ~CHalUSBServiceProxy();
...
private:
	CHalUSBLayerService m_HalSrvAddr;
