#ifndef __HAL_HID_LAYER_SERVICE__
#define __HAL_HID_LAYER_SERVICE__
/**************************************************************************************/
#include "Wait.h"
#include "RefBase.h"
...
class CHalHIDLayerService : public CBSPRService
{
private:
	CHalHIDLayerService( const CHalHIDLayerService& );
public:
	CHalHIDLayerService(  );
	virtual ~CHalHIDLayerService();
	...
	***************************************************************************************/
	BOOL HasReceiveDataInQueue( UINT32 queryTimeout );
 	...
 	DECLEAR_SERVICE( CHalHIDLayerService )
