#pragma once
#include "Config.h"
class CConfig5816 : public CConfig
{
public:
	CConfig5816( unsigned short type );
	virtual ~CConfig5816();
...
public:
	//config
	unsigned short ic_2_sensor_map[MAX_RX_NUM_5816 + MAX_TX_NUM_5816];
	unsigned short sensor_2_ic_map[MAX_RX_NUM_5816 + MAX_TX_NUM_5816];
...
// 	unsigned short os_base[MAX_SCAP_ROW][MAX_SCAP_COL];
	...
	unsigned int  tick_24m_standard;
	unsigned char trim_24m_min;
	unsigned char trim_24m_max;
	//base test
...
// 	/*unsigned*/ short base_max[MAX_MCAP_ROW][MAX_MCAP_COL];
	...
	unsigned int vdd_low_min;
	unsigned int vdd_low_max;
	unsigned int vdd_high_min;
	unsigned int vdd_high_max;
